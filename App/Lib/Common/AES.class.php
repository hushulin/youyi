...
/**
 *
 * @author wenliang 2013-7-13 上午11:15:08 AES.class.php
 *         tags
 */
class AES
{
    ...
    public function makeKey($hash)
    {
        ...
        for ($j = 0; $j < $this->Nk; $j ++)
            for ($i = 0; $i < 4; $i ++)
                $tk[$i][$j] = ord($hash[$j * 4 + $i]) > 256 ? ord($hash[$j * 4 + $i]) % 256 : ord($hash[$j * 4 + $i]); // ת����ASCII��ֵ
        $t = 0;
     ...
     * @todo
     *
     * @param unknown $excodeStr            
     * @param unknown $expandedKeys            
     * @return string
     */
     ...
     * @param unknown $expandKeys            
     * @param string $destPath            
     * @param string $encodeFile            
     */
