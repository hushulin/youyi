					...
					<fieldset>
						<div class="tab tab_1">
							<div class="formitm">
									...
									<div class="ipt">
										<select class="u-select" name="user_id"><?php if(is_array($field_user_id)): $i = 0; $__LIST__ = $field_user_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == "") echo "selected"; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<select class="u-select" name="goods_id"><?php if(is_array($field_goods_id)): $i = 0; $__LIST__ = $field_goods_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == "") echo "selected"; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select>
										<p></p>
									</div>
								</div>
