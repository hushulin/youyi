...
<body onselectstart="return false">
	...
	<div id="main" class="g-main">
		...
		<div class="row">
<?php  $rurl = base64_decode($_GET["rurl"]); $rurl = empty($rurl)?U("/Admin/User"):$rurl; ?>			<a class="u-btn" href="<?php echo ($rurl); ?>">返回列表</a>
		</div>
		<div class="row">
					...
					<fieldset>
						<div class="tab tab_1">
							...
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="user_name" value="<?php echo ($doc["user_name"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="password" value="<?php echo ($doc["password"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="phone" value="<?php echo ($doc["phone"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="file" class="u-file" name="face" /><div><img src="<?php echo ($doc["face"]); ?>" style="height:100px;"></div>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									<label class="lab">有效性:</label>
									<div class="ipt">
						...
						<div class="tab tab_2">
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="nick_name" value="<?php echo ($doc["nick_name"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="qq" value="<?php echo ($doc["qq"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="email" value="<?php echo ($doc["email"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									<label class="lab">积分:</label>
									<div class="ipt">
										<input type="text" class="u-ipt" name="score" value="<?php echo ($doc["score"]); ?>"/>
										<p></p>
									</div>
								</div>
						</div>
