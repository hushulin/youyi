					...
					<fieldset>
						<div class="tab tab_1">
							...
							<div class="formitm">
								...
								<div class="ipt">
									<input type="text" class="u-ipt" name="sort" value="0"/>
									<p>用于分组显示的顺序</p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<input type="text" class="u-ipt" name="url"/>
									<p>U函数解析的URL或者外链</p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<select class="u-select" name="pid"/>
										...
										<?php if(is_array($admin_menu_list)): $i = 0; $__LIST__ = $admin_menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
									<p>所属的上级菜单</p>
								</div>
							</div>
						...
						<div class="tab tab_2">
							<div class="formitm">
								...
								<div class="ipt">
									<input type="text" class="u-ipt" name="group"/>
									<p>用于左侧分组二级菜单</p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<input type="radio" name="hide" /> 是
									<input type="radio" name="hide" checked="checked" /> 否
									<p></p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<input type="radio" name="is_dev" /> 是
									<input type="radio" name="is_dev" checked="checked" /> 否
									<p></p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<textarea class="u-textarea" name="tip"></textarea>
									<p></p>
								</div>
							</div>
						</div>
