					...
					<fieldset>
						<div class="tab tab_1">
							...
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="text" value=""/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<?php if(is_array($field_position)): $i = 0; $__LIST__ = $field_position;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="radio" name="position" value="<?php echo ($key); ?>" <?php if($key == 1) echo 'checked="checked"';?> >&nbsp;&nbsp;<?php echo ($vo); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
										<p></p>
									</div>
								</div>
						</div>
