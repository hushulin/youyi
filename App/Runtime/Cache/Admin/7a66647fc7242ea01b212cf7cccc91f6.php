...
<body onselectstart="return false">
	...
	<div id="main" class="g-main">
		...
		<div class="row">
<?php  $rurl = base64_decode($_GET["rurl"]); $rurl = empty($rurl)?U("/Admin/Article"):$rurl; ?>			<a class="u-btn" href="<?php echo ($rurl); ?>">返回列表</a>
		</div>
		<div class="row">
					...
					<fieldset>
						<div class="tab tab_1">
							...
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="sub_title" value="<?php echo ($doc["sub_title"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
					...
					KindEditor.ready(function(K) {
						editor = K.create('textarea[name="content"]', {
							...
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="author" value="<?php echo ($doc["author"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="keyword" value="<?php echo ($doc["keyword"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<textarea class="u-textarea" name="desc"><?php echo ($doc["desc"]); ?></textarea>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="click" value="<?php echo ($doc["click"]); ?>"/>
										<p></p>
									</div>
								</div>
						</div>
