					...
					<fieldset>
						<div class="tab tab_1">
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="user_name" value=""/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="password" value=""/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="phone" value=""/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="file" class="u-file" name="face" />
										<p></p>
									</div>
								</div>
							<div class="formitm">
						...
						<div class="tab tab_2">
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="nick_name" value=""/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="qq" value=""/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="email" value=""/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="score" value=""/>
										<p></p>
									</div>
								</div>
						</div>
