...
<body onselectstart="return false">
	...
	<div id="main" class="g-main">
		...
		<div class="row">
			<a class="u-btn" href="<?php echo U('/Admin/Table/add');?>">新 增</a>
			<a class="u-btn" href="<?php echo U('/Admin/Table/mgen');?>" target="_blank">一键生成所有模型</a>
		</div>
		<div class="row">
			<table class="m-table">
				<thead>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php if(isset($field_type)){echo $field_type[$vo["type"]];}else{echo $vo["type"];}?></td>
						<td>
							<a href="<?php echo U('/Admin/Table/edit/id/'.$vo['id']);?>" title="">编辑</a>
							<a href="<?php echo U('/Admin/Table/del/id/'.$vo['id']);?>" title="">删除</a>
							<a href="<?php echo U('/Admin/Table/gen/id/'.$vo['id']);?>" title="">生成</a>
						</td>
