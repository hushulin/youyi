					...
					<fieldset>
						<div class="tab tab_1">
							...
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="tuijian_user" value="<?php echo ($doc["tuijian_user"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<select class="u-select" name="cate_id"><?php if(is_array($field_cate_id)): $i = 0; $__LIST__ = $field_cate_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $doc["cate_id"]) echo 'selected="selected"'; ?> ><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<select class="u-select" name="type_id"><?php if(is_array($field_type_id)): $i = 0; $__LIST__ = $field_type_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $doc["type_id"]) echo 'selected="selected"'; ?> ><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="tag" value="<?php echo ($doc["tag"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
					...
					KindEditor.ready(function(K) {
						...
						<div class="tab tab_2">
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="price" value="<?php echo ($doc["price"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="out" value="<?php echo ($doc["out"]); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="urlstring" value="<?php echo ($doc["urlstring"]); ?>"/>
										<p></p>
									</div>
								</div>
						</div>
