					...
					<fieldset>
						<div class="tab tab_1">
							...
							<div class="formitm">
								...
								<div class="ipt">
									<input type="hidden" class="u-ipt" name="orname" value="<?php echo ($doc["name"]); ?>"/>
									<input type="text" class="u-ipt" name="name" value="<?php echo ($doc["name"]); ?>"/>
									<p>标识用于程序控制</p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<select name="type" class="u-select" id="type">
										<?php if(is_array($field_type)): $i = 0; $__LIST__ = $field_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $doc["type"]) echo "selected='selected'"; ?>><?php echo ($vi); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
									<p>用于表单中的展示方式</p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<input type="text" class="u-ipt" name="define" id="define" value="<?php echo ($doc["define"]); ?>"/>
									<p>字段属性的sql表示</p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<input type="hidden" name="para" id="para" value='<?php echo ($doc["para"]); ?>'>
									<input type="button" class="u-btn" id="para_btn" value="参数">
									<span class="u-ipt" id="para_span"><?php echo ($doc["para"]); ?></span>
							...
							<div class="formitm">
								...
								<div class="ipt">
									<input type="text" class="u-ipt" name="default" value="<?php echo ($doc["default"]); ?>"/>
									<p>字段的默认值</p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<input type="text" class="u-ipt" name="description" value="<?php echo ($doc["description"]); ?>"/>
									<p>用于表单中的提示</p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<select name="show_type" class="u-select">
										<?php if(is_array($field_show_type)): $i = 0; $__LIST__ = $field_show_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $doc["show_type"]) echo "selected='selected'"; ?>><?php echo ($vi); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
									<p>是否显示在表单中</p>
								</div>
							</div>
						...
						<div class="tab tab_2">
							<div class="formitm">
								...
								<div class="ipt">
									<select name="check_type" class="u-select">
										<?php if(is_array($field_check_type)): $i = 0; $__LIST__ = $field_check_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $doc["check_type"]) echo "selected='selected'"; ?>><?php echo ($vi); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
									<p>是否显示在表单中</p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<input type="text" class="u-ipt" name="check_rule" value="<?php echo ($doc["check_rule"]); ?>"/>
									<p>根据验证方式定义相关验证规则</p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<input type="text" class="u-ipt" name="check_msg" value="<?php echo ($doc["check_msg"]); ?>"/>
									<p></p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<select name="check_time" class="u-select">
										<?php if(is_array($field_check_time)): $i = 0; $__LIST__ = $field_check_time;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $doc["check_time"]) echo "selected='selected'"; ?>><?php echo ($vi); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
									<p></p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<select name="default_type" class="u-select">
										<?php if(is_array($field_default_type)): $i = 0; $__LIST__ = $field_default_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $doc["default_type"]) echo "selected='selected'"; ?>><?php echo ($vi); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
									<p></p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<input type="text" class="u-ipt" name="default_rule" value="<?php echo ($doc["default_rule"]); ?>"/>
									<p></p>
								</div>
							</div>
							<div class="formitm">
								...
								<div class="ipt">
									<select name="default_time" class="u-select">
										<?php if(is_array($field_default_time)): $i = 0; $__LIST__ = $field_default_time;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $doc["default_time"]) echo "selected='selected'"; ?>><?php echo ($vi); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
									<p></p>
								</div>
							</div>
