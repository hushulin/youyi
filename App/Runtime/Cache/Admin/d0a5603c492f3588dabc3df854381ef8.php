					...
					<fieldset>
						<div class="tab tab_1">
							<div class="formitm">
									...
									<div class="ipt">
										<select class="u-select" name="position_id"><?php if(is_array($field_position_id)): $i = 0; $__LIST__ = $field_position_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == "") echo "selected"; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select>
										<p></p>
									</div>
								</div>
							...
							<div class="formitm">
									...
									<div class="ipt">
										<select class="u-select" name="user_id"><?php if(is_array($field_user_id)): $i = 0; $__LIST__ = $field_user_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == "0") echo "selected"; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select>
							...
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt time" name="time" value="<?php echo date("Y-m-d h:i", time()); ?>"/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
									...
									<div class="ipt">
										<input type="text" class="u-ipt" name="url" value=""/>
										<p></p>
									</div>
								</div>
							<div class="formitm">
					...
					KindEditor.ready(function(K) {
						editor = K.create('textarea[name="content"]', {
							...
							<div class="formitm">
									...
									<div class="ipt">
										<?php if(is_array($field_is_effect)): $i = 0; $__LIST__ = $field_is_effect;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="radio" name="is_effect" value="<?php echo ($key); ?>" <?php if($key == 1) echo 'checked="checked"';?> >&nbsp;&nbsp;<?php echo ($vo); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
										<p></p>
									</div>
								</div>
						</div>
